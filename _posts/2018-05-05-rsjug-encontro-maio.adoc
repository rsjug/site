...
O Grupo de Usuários Java do RS, o RSJUG, se reúne no dia *05 de Maio de 2015* para realizar um encontro com palestras de DDD, Domain Events e Events Sourcing.
